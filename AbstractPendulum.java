...
public abstract class AbstractPendulum {
    ...
    private boolean validGC (GravityModel val) { return (val.getGravitationalField() >= 0); }
    ...
    public double getGravitationalField () { return gmodel.getGravitationalField(); }
    //Allow the GravityModel to be changed dynamically
    public void changeGravitationalField( GravityModel h) { gmodel = h ;}
